...
extension IsarImageStorageSettingQueryWhere on QueryBuilder<
  ...
  QueryBuilder<IsarImageStorageSetting, IsarImageStorageSetting,
      QAfterWhereClause> typeStartsWith(String TypePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'type',
        lower: [TypePrefix],
  ...
  QueryBuilder<IsarImageStorageSetting, IsarImageStorageSetting,
      QAfterWhereClause> typeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<IsarImageStorageSetting, IsarImageStorageSetting,
      QAfterWhereClause> configEqualTo(String config) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'config',
        value: [config],
  ...
  QueryBuilder<IsarImageStorageSetting, IsarImageStorageSetting,
      QAfterWhereClause> configNotEqualTo(String config) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
